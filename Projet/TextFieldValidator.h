 ...
 */
#define ColorPopUpBg [UIColor colorWithRed:255 green:255 blue:255 alpha:0.7]

/**
 Font color of the message.
 */
#define ColorFont [UIColor colorWithRed:0 green:0 blue:0 alpha:1]
 ...
 */
#define FontName @"Comfortaa-Light"
 ...
 */
NS_CLASS_AVAILABLE_IOS(6_0) @interface TextFieldTest : UITextField<UITextFieldDelegate>{
    
}

@property (nonatomic,assign) BOOL isMandatory;   /**< Default is YES*/

@property (nonatomic,retain) IBOutlet UIView *present;    /**< Assign view on which you want to show popup and it would be good if you provide controller's view*/
 ...
 */
-(void)addConfirmValidationTo:(TextFieldTest *)txtPassword withMsg:(NSString *)msg;
