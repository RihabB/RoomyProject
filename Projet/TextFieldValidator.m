...
@synthesize present,validateOnCharacterChanged,popUpColor,isMandatory,validateOnResign;
...
-(void)showErrorWithMsg:(NSString *)msg{
    ...
    popUp.showOnRect=[self convertRect:self.rightView.frame toView:present];
    popUp.fieldFrame=[self.superview convertRect:self.frame toView:present];
    popUp.backgroundColor=[UIColor clearColor];
    [present addSubview:popUp];
